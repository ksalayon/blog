...
<?php echo $this->Form->create('MainTopic'); ?>
	<fieldset>
		<legend><?php echo __('Edit Main Topic'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('MainTopic.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('MainTopic.id'))); ?></li>
